...
# Load raw crypto data from CSV
def load_crypto_data(ticker, folder="crypto_data"):
...
def read_tickers_from_file(filename="coins.txt"):
    try:
...
def process_crypto_data(ticker):
...
def main():
    ...
    tickers = read_tickers_from_file("coins.txt")
    for ticker in tickers:
        print(f"Processing {ticker}...")
        process_crypto_data(ticker)
